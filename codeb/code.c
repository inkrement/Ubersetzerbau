...
static short burm_nts_4[] = { burm_expr_NT, burm_immediate_NT, 0 };
...
NODEPTR_TYPE *burm_kids(NODEPTR_TYPE p, int eruleno, NODEPTR_TYPE kids[]) {
	...
	switch (eruleno) {
	case 47: /* zeroexpr: OP_Id */
	case 42: /* zeroexpr: immediate */
	case 41: /* zeroexpr: zero */
	case 33: /* immediate: zero */
	case 27: /* expr: immediate */
	case 1: /* stat: ret */
		kids[0] = p;
		break;
	case 43: /* zeroexpr: OP_NEG(zeroexpr) */
	case 37: /* zero: OP_NEG(zero) */
	case 29: /* immediate: OP_NEG(immediate) */
	case 28: /* immediate: OP_NOT(immediate) */
	case 22: /* expr: OP_Field(expr) */
	case 20: /* expr: OP_NEG(expr) */
	case 13: /* ret: OP_Return(expr) */
	case 6: /* expr: OP_NOT(expr) */
	case 3: /* stat: OP_With(expr) */
	case 2: /* stat: OP_With(immediate) */
		kids[0] = LEFT_CHILD(p);
		break;
	case 48: /* zeroexpr: OP_GREATER(zeroexpr,zeroexpr) */
	case 46: /* zeroexpr: OP_NEQ(zeroexpr,zeroexpr) */
	case 45: /* zeroexpr: OP_MUL(zeroexpr,zeroexpr) */
	case 44: /* zeroexpr: OP_ADD(zeroexpr,zeroexpr) */
	case 40: /* zero: OP_MUL(zero,zeroexpr) */
	case 39: /* zero: OP_MUL(zeroexpr,zero) */
	case 32: /* immediate: OP_MUL(immediate,immediate) */
	case 31: /* immediate: OP_ADD(immediate,immediate) */
	case 30: /* immediate: OP_NEQ(immediate,immediate) */
	case 26: /* expr: OP_GREATER(expr,immediate) */
	case 25: /* expr: OP_GREATER(immediate,expr) */
	case 24: /* expr: OP_GREATER(expr,expr) */
	case 19: /* expr: OP_MUL(expr,immediate) */
	case 18: /* expr: OP_MUL(immediate,expr) */
	case 17: /* expr: OP_MUL(expr,expr) */
	case 16: /* expr: OP_ADD(expr,immediate) */
	case 15: /* expr: OP_ADD(immediate,expr) */
	case 14: /* expr: OP_ADD(expr,expr) */
	case 12: /* expr: OP_NEQ(expr,immediate) */
	case 11: /* expr: OP_NEQ(immediate,expr) */
	case 10: /* expr: OP_NEQ(expr,expr) */
	case 9: /* expr: OP_OR(expr,immediate) */
	case 8: /* expr: OP_OR(expr,expr) */
	case 7: /* expr: OP_OR(immediate,expr) */
	case 5: /* stat: OP_LEXPR(expr,immediate) */
	case 4: /* stat: OP_LEXPR(expr,expr) */
		kids[0] = LEFT_CHILD(p);
		kids[1] = RIGHT_CHILD(p);
		break;
	case 38: /* zero: OP_Zero */
	case 36: /* immediate: OP_One */
	case 35: /* immediate: OP_Zero */
	case 34: /* immediate: OP_Number */
	case 23: /* expr: OP_Fieldvariable */
	case 21: /* expr: OP_ID */
		break;
	default:
...
void burm_reduce(NODEPTR_TYPE bnode, int goalnt)
{
 ...
 printf("\ttodo width expr: reg %s\n", bnode->reg);move(bnode->child[0]->reg, bnode->reg);
    break;
  case 4:
 printf("\ttodo: lexpr expr\n"); move(bnode->child[1]->reg, bnode->reg);
    break;
  case 5:
 printf("\ttodo: lexpr imm\n"); movei(bnode->child[1]->value, bnode->reg);
    break;
  case 6:
 not(bnode->reg);
    break;
 ...
 move_offset(bnode->child[0]->reg, bnode->reg, bnode->offset);
    break;
  case 23:
 printf("\ttodo: fieldvar\n"); move_offset(bnode->reg, bnode->reg, bnode->offset);
    break;
  case 24:
